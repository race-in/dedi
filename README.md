...
## Usage
`bash <(wget -qO- https://raw.githubusercontent.com/race-in/dedi/main/Install.sh) -u <username> -p <password> -c <Cache Size(unit:MiB)> -q <qBittorrent Version> -l <libtorrent Version> -b -v -r -3 -x -o`
#### Options
	1. -u: username 
	2. -p: password
